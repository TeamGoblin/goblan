...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "icon-bolt", bindCommand("doCode"), group2);
            ...
            buttons.heading = makeButton("wmd-heading-button", "Heading - Ctrl+H", "icon-double-angle-up", bindCommand("doHeading"), group3);
            ...
            var redoTitle = /win/.test(nav.platform.toLowerCase()) ?
                "Redo - Ctrl+Y" :
                "Redo - Ctrl+Y"; // mac and other non-Windows platforms
